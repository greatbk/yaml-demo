...
@SpringBootTest
@Slf4j
public class MciEnteriesPrdTest {
    ...
    public void test1() {
        ...
        assertThat(list.get(0).getProtocol(), is("https"));
        assertThat(list.get(0).getAddress(), is("p-mciap"));
        ...
        assertThat(list.get(1).getProtocol(), is("https"));
        assertThat(list.get(1).getAddress(), is("p-mciap"));
        ...
        assertThat(list.get(2).getProtocol(), is("https"));
        assertThat(list.get(2).getAddress(), is("p-mciap"));
        ...
        assertThat(list.get(3).getProtocol(), is("https"));
        assertThat(list.get(3).getAddress(), is("p-mciap"));
    ...
    public void test2() {
        ...
        assertThat(mciRemoteMgr.getRemote("DIS").getProtocol(), is("https"));
        assertThat(mciRemoteMgr.getRemote("DIS").getAddress(), is("p-mciap"));
        ...
        assertThat(mciRemoteMgr.getRemote("UBI").getProtocol(), is("https"));
        assertThat(mciRemoteMgr.getRemote("UBI").getAddress(), is("p-mciap"));
        ...
        assertThat(mciRemoteMgr.getRemote("SMC").getProtocol(), is("https"));
        assertThat(mciRemoteMgr.getRemote("SMC").getAddress(), is("p-mciap"));
        ...
        assertThat(mciRemoteMgr.getRemote("PNP").getProtocol(), is("https"));
        assertThat(mciRemoteMgr.getRemote("PNP").getAddress(), is("p-mciap"));
